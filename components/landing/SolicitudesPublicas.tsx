...
const solicitudesMock: SolicitudCard[] = [
  ...
  },
  {
    ...
    tipo: "ALIMENTO" as const,
    descripcion: "Requerimos frutas y verduras frescas para los alimentos de esta semana. Recibimos donaciones de proveedores.",
    ciudad: "Cali",
  ...
  },
  {
    ...
    tipo: "PRODUCTO" as const,
    descripcion: "Pañales, cremas y productos especializados para cuidado de bebés y madres lactantes. Donación prioritaria.",
    ciudad: "Bogota",
